...
// camera
Camera camera(glm::vec3(4.0f, 4.0f, 6.0f), glm::vec3(0.0f, 1.0f, 0.0f), -90.0f, -45.0f);
...
// lighting
glm::vec3 lightPos(0.0f, 1.0f, 1.5f);
...
int main(void)
{
    ...
    unsigned int objectVAO, lightVAO;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightPos.y = cos(glfwGetTime()) * 3.0f;
